      ...
      appBar: AppBar(
        ...
        actions: [
          Container(
            // height: 20,
            width: 80,
              margin: const EdgeInsets.only(right: 16,bottom: 12,top: 16),
              ...
              child: Row(
                children: [
                  ...
                  const Text('10',textAlign: TextAlign.center,style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold)),
                  // SizedBox(width: ,),
                  InkWell(onTap: (){log("Hi");},child: const Icon(Icons.add,color: Colors.black,))
                ],
              ))
        ],
      ),
